...
function apply(d){O.t=function(k,def){return d[k]!=null?d[k]:def};document.querySelectorAll("[data-i18n]").forEach(function(el){var v=d[el.getAttribute("data-i18n")];if(v!=null)el.innerHTML=v});reveal()}
